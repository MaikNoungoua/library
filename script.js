...
gridGeneration = function (args){

    let bookAddition = `url('${args.coverPage}')`; 
    ...
    //creating grid dynamically or
        ...
        let coverToAdd = document.getElementById("book-container");
        tile = document.getElementsByClassName('book-slots');
        tile.body.style.backgroundImage = bookAddition;
        coverToAdd.appendChild(tile);
        //bookToAdd.style.backgroundColor = 'red';
};
